...
(Level.newFruit$ret.3)
	...
	////IF-GOTO
		...
		AM=M-1
		D=M
	@Level.newFruit$RAND_DECR
	D;JNE


	////GOTO
	@Level.newFruit$ADD_FRUIT
	0;JMP
...
(Level.checkCollision)
	...
	////IF-GOTO
		...
		AM=M-1
		D=M
	@Level.checkCollision$GAME_OVER
	D;JNE
...
(Level.checkCollision$ret.5)
	...
	////GOTO
	@Level.checkCollision$NO_GAME_OVER
	0;JMP
